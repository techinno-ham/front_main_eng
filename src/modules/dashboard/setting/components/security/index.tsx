            ...
            <div>
                <div className="p-5">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-zinc-500">
                            Limit the number of messages sent from a device in an iframe and chat bubble (this limit does not apply to you in chatsys.co, only on your website for your users to prevent abuse).
                        </p>
