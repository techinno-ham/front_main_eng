    ...
    <div className="content-cta-main">
        <div className="head-section">
            <div className="title-section-footer">
                ...
                2 minutes to your first AI-powered assistant with Hamyar
                </h3>
            </div>
        ...
        <Link href={"/mybots"}>
            <button type="button" className="
                ...
                Start for Free
                <span aria-hidden="true" className="mr-1 transform transition-all duration-500 ease-in-out group-hover/cta:translate-x-1">→</span>
            </button>
        </Link>
        </div>
    </div>
