...
let cards = [
    {
        ...
        subTitle: "Import data from multiple sources to train your chatbot.",
        Icon: (
    ...
    {
        title: "Customization",
        subTitle: "Customize the look and feel of your chatbot to match your brand's website style and design.",
        Icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="30" className="text-blue-500">
    ...
    },
    {
        ...
        subTitle: "Your data is hosted on secure servers with strong encryption and access controls.",
        Icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="30" className="text-blue-500">
    ...
    {
        title: "Automatic Re-Training",
        subTitle: "Automatically train your chatbot and always stay up-to-date with your data.",
        Icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="30" className="text-blue-500">
    ...
    {
        title: "Integrations",
        subTitle: "Connect your chatbot to your favorite tools like Slack, WhatsApp, Zapier, and more.",
        Icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="30" className="text-blue-500">
    ...
    },
    {
        ...
        subTitle: "Choose from various AI models including GPT-3.5-turbo and GPT-4.",
        Icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="30" className="text-blue-500">
    ...
    {
        title: "Over 80 Languages",
        subTitle: "Reach your customers in their native language, even if your data is in a different language.",
        Icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="30" className="text-blue-500">
