...
let cards = [
    ...
    },
    {
        title: "Customization",
        subTitle:
            "Customize the look and feel of your chatbot to match your brand's website style and design.",
        Icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
    ...
    },
    {
        ...
        subTitle:
            "Your data is hosted on secure servers with strong encryption and access controls.",
        Icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
    ...
    },
    {
        ...
        subTitle:
            "Automatically train your chatbot and always stay up-to-date with your data.",
        Icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
    ...
    },
    {
        ...
        subTitle:
            "Choose from various AI models including GPT-3.5-turbo and GPT-4.",
        Icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        >
            <div className="mt-10 md:mt-4">
                <h2 className="text-3xl font-medium md:text-5xl">
                    <span>Unlock Powerful </span>
                    <span className="gradient-h2 is-v2">Chatsys Features</span>
                </h2>
                <h3 className="mt-1 text-[12px] md:mt-3 md:text-[16px]">
                    Fully customize AI agents with Chatsys&apos;s advanced,
                    user-friendly tools.
                </h3>
            </div>
