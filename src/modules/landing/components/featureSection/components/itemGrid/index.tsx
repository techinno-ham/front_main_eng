...
>
    <div className="template-image-path">
        ...
        <div className="info-path">
            ...
            <div className="description-info-path">
                A digital assistant that helps IT teams in various areas...
            </div>
            <div className="text-botpress-small">
                Chat Helper
            </div>
    ...
    <div className="template-image-path">
        ...
        <div className="info-path">
            ...
            <div className="description-info-path">
                A customer support chatbot that assists customers in various areas...
            </div>
            <div className="text-botpress-small">
                Chat Helper
            </div>
    ...
    <div className="template-image-path">
        ...
        <div className="info-path">
            ...
            <div className="description-info-path">
                The Sales Assistant offers assistance with your sales team...
            </div>
            <div className="text-botpress-small">
                Chat Helper
            </div>
...
>
    <div className="template-image-path">
        ...
        <div className="info-path">
            ...
            <div className="description-info-path">
                Helps manage personnel-related tasks...
            </div>
            <div className="text-botpress-small">
                HelpChat
            </div>
    ...
    <div className="template-image-path">
        ...
        <div className="info-path">
            ...
            <div className="description-info-path">
                Helps users with daily tasks such as...
            </div>
            <div className="text-botpress-small">
                HelpChat
            </div>
...
>
    <div className="template-image-path">
        ...
        <div className="info-path">
            <div className="title-info-path">Language Teacher</div>
            <div className="description-info-path">
                An educational chatbot to assist in learning foreign languages...
            </div>
            <div className="text-botpress-small">
                HelpChat
            </div>
