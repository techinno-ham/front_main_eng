...
const FreePricingMobile = () => {
    ...
    <div className="flex w-full flex-row items-center justify-between px-2">
        <div className="flex flex-col items-start justify-center">
            ...
            <span className="text-sm text-zinc-400">Always</span>
        </div>
        <a href="/mybots">
    ...
    <div data-orientation="horizontal" role="none" className="h-0.5 w-full shrink-0 bg-zinc-200 drop-shadow-lg "></div>
