        ...
        <div className=" bg-[#F6F8FB]font-[sans-serif] h-full min-h-screen ">
            ...
            <div className="flex justify-center">
                <div className="absolute top-[110px] z-10 flex max-w-md flex-col">
                    ...
                    <form className="relative z-10 rounded-2xl  bg-white p-6 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]"   onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-10">
                        ...
                        <div>
                              <Link href={"/auth"} className=" text-sm font-semibold text-blue-600 hover:underline">
                        ...
                        <div className="mt-10">
                            <button
                               type="submit"
                                className="w-full flex justify-center gap-3 rounded-md bg-blue-600 px-4 py-2.5 text-sm font-semibold tracking-wider text-white hover:bg-blue-700 focus:outline-none"
                            >
                              {isLoading ? (
                                <>
                                 <span className="mr-3">
                            ...
                            <p className="mt-6 text-center text-sm">
                               ...
                               <Link href={"/auth/register"} className=" ml-1 whitespace-nowrapfont-semibold text-blue-600 hover:underline">
                               ثبت نام
                               </Link>
