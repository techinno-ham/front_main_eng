                        ...
                        <div className="flex items-center lg:pl-[100px]">
                            <div className="data w-full">
                                ...
                                <p className="mx-auto max-w-2xl text-xl font-normal leading-8 text-gray-500 max-lg:text-center">
                                    با انگیزه‌ای از علاقه به تجربه‌های کاربری
                                    بی‌نقص، ما pagedone را با دقت گردآوری
                                    کرده‌ایم تا خالقان، طراحان و توسعه‌دهندگان
                                    را توانمند کنیم. مأموریت ما ارائه یک جعبه
                                    ابزار جامع است که به شما امکان می‌دهد
                                    رابط‌های کاربری زیبا و شهودی بسازید که در هر
                                    تعامل با کاربران ارتباط برقرار کند.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                        <div className="flex items-center lg:pr-24">
                            <div className="data w-full">
                                ...
                                <p className="mx-auto max-w-2xl text-xl font-normal leading-8 text-gray-500 max-lg:text-center">
                                    Pagedone تنها یک مجموعه از اجزاء و
                                    دستورالعمل‌ها نیست؛ بلکه یک فلسفه است. ما
                                    فراتر از زیبایی‌شناسی رفته و اولویت را به
                                    دسترسی‌پذیری، مقیاس‌پذیری و کارایی می‌دهیم.
                                    هر عنصر، از کوچکترین جزئیات تا بزرگترین
                                    طرح‌ها، با دقت ساخته شده تا کارایی را بهبود
                                    بخشد و رضایت کاربران را افزایش دهد.
                                </p>
                            </div>
                        </div>
                        <div className="img-box ">
                            ...
                            ساده‌تر کند.
                                ...
                                <div className="group flex w-full flex-wrap items-center gap-8  p-8 transition-all duration-500  lg:flex-nowrap">
                                    ...
                                    <div className="flex-1 text-center lg:max-w-xs lg:text-left">
                                        ...
                                        <p className="mb-7 leading-6 text-gray-500">
                                            I am the co founder of pagedone and
                                            we’ve pushed our limit so far to
                                            make it successful.
                                        </p>
                                ...
                                <div className="group flex w-full flex-col flex-wrap items-center gap-8 p-8 transition-all duration-500 md:flex-row lg:flex-nowrap">
                                    ...
                                    <div className="flex flex-1 flex-col justify-between text-center lg:max-w-xs lg:text-left">
                                        ...
                                        <p className="mb-7 leading-6 text-gray-500">
                                            I’ve been lead designer for pagedone
                                            since the beginning of it and
                                            enjoyed every bit.
                                        </p>
