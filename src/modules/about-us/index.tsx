    ...
    return (
        <>
            <section className="relative z-0 bg-gray-50 py-14 lg:py-24">
                <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
                    ...
                    هوشمندانه سرمایه گذاری کنید و راه بهتری برای مدیریت آسان تمام دارایی های خود را کشف کنید.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 gap-9 lg:grid-cols-2">
                        ...
                        <div className="flex items-center lg:pl-[100px]">
                            <div className="data w-full">
                                ...
                                با انگیزه‌ای از علاقه به تجربه‌های کاربری بی‌نقص، ما pagedone را با دقت گردآوری کرده‌ایم تا خالقان، طراحان و توسعه‌دهندگان را توانمند کنیم. مأموریت ما ارائه یک جعبه ابزار جامع است که به شما امکان می‌دهد رابط‌های کاربری زیبا و شهودی بسازید که در هر تعامل با کاربران ارتباط برقرار کند.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                        <div className="flex items-center lg:pr-24">
                            <div className="data w-full">
                                ...
                                ما از سال ۲۰۰۵ خلاق هستیم
                                </h2>
                                <p className="mx-auto max-w-2xl text-xl font-normal leading-8 text-gray-500 max-lg:text-center">
                                Pagedone تنها یک مجموعه از اجزاء و دستورالعمل‌ها نیست؛ بلکه یک فلسفه است. ما فراتر از زیبایی‌شناسی رفته و اولویت را به دسترسی‌پذیری، مقیاس‌پذیری و کارایی می‌دهیم. هر عنصر، از کوچکترین جزئیات تا بزرگترین طرح‌ها، با دقت ساخته شده تا کارایی را بهبود بخشد و رضایت کاربران را افزایش دهد.
                        ...
                        <div className="mx-auto w-full rounded-2xl bg-white p-6 shadow-md shadow-gray-100 max-lg:max-w-2xl lg:mx-0 lg:w-1/3">
                            <div className="flex gap-5">
                                ...
                                <div className="flex-1">
                                    ...
                                    سفر قابل توجه رشد شرکت ما با نوآوری مداوم و حرکت به سوی افق‌های جدید موفقیت.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="mx-auto w-full rounded-2xl bg-white p-6 shadow-md shadow-gray-100 max-lg:max-w-2xl lg:mx-0 lg:w-1/3">
                            <div className="flex gap-5">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs leading-5 text-gray-500">
                                    اعضای بسیار با استعداد تیم ما موتور محرک pagedone و ستون‌های موفقیت ما هستند.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="mx-auto w-full rounded-2xl bg-white p-6 shadow-md shadow-gray-100 max-lg:max-w-2xl lg:mx-0 lg:w-1/3">
                            <div className="flex gap-5">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs leading-5 text-gray-500">
                                    ما بیش از ۶۲۵ پروژه در سراسر جهان به انجام رسانده‌ایم و همچنان به شمارش ادامه می‌دهیم.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="relative mb-20">
                                    <div className="mx-auto max-w-max lg:max-w-4xl">
                                        <p className="mb-8 text-center text-lg leading-8 text-gray-500">
                                            من تا چند ماه از pagedone استفاده می‌کنم، و باید بگویم که واقعاً زندگی‌ام را آسان‌تر کرده است. رابط کاربری شهودی و سادگی استفاده از این پلتفرم به من امکان می‌دهد که مالی خود را به صورت مؤثرتر مدیریت کنم و تصمیمات سرمایه‌گذاری خود را با آگاهی بیشتری بگیرم. به طور خاص، ویژگی پیگیری خودکار محصول را بسیار دوست دارم که به من بسیاری از زمان و زحمت را صرفه جویی کرده است.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-24">
                ...
                ما همه مزایایی را فراهم می‌کنیم که می‌تواند تمام پشتیبانی‌های مالی و بانکی شما را بدون هیچ مشکل دیگری ساده‌تر کند.
                </p>
            </div>
