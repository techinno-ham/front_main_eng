...
const sendRequest = async (_valueInput?: string) => {
    ...
    if (numberMesaage == 0) {
        setMessages({
            ...
            error: true,
            content:
                "Your demo chatbot usage limit has been reached. To access more features, please log into your user panel.",
        ...
        try {
            ...
            setMessages({
                ...
                error: true,
                content:
                    "I am currently facing technical difficulties. 😕 Please try again later or start a live chat with our team. 🛠️",
                id: `message-id-${messages.length}`,
                time: Date.now(),
            })
        ...
        <div className="w-80">
            ...
            <div className="text-center">
                <p className="text-[#16a34a]">
                    Your demo chatbot has been successfully created.
                </p>
                <span className="text-[12px] text-gray-400">
                    The reason for the chatbot's inability to respond in certain cases is due to insufficient or limited information. To get more practical use, please log in to your user panel.
                </span>
            </div>
            <div className="mt-4 text-center">
                <p className="font-bold text-gray-700 text-[14px]">Links reviewed for learning:</p>
...
<div className="scrollable-container h-full overflow-auto" ref={chatContainerRef}>
