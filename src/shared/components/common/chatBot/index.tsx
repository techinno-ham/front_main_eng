    ...
    return (
        ...
        {!chatBotActive ? (
            <>
             ...
             <div className="flex h-[85vh] max-h-[824px] flex-auto shrink-0 flex-col overflow-hidden rounded-xl border border-zinc-400  bg-zinc-100  relative">
             <div className="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 flex flex-col justify-center items-center">
             <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-14 h-14 animate-spin"
    viewBox="0 0 16 16">
    <path
                                    ...
                                    <div className="mr-8 flex justify-end">
                                        <div className="mb-3 max-w-prose overflow-auto rounded-lg bg-[#f1f1f0] px-4 py-3 text-black">
                                            <div className="flex flex-col items-start gap-4 break-words">
                                                <div className=" w-full break-words text-right text-inherit pointer-events-none ">
                                                    <p>
                                                        سلام ! امروز چطور
                                                        می‌توانم به شما کمک
                                                        کنم؟ 😊
                    ...
                    <form action="">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="flex items-center justify-center gap-3 px-4 pb-3 pt-1">
                                <p className="grow text-nowrap text-center text-xs  pointer-events-none">
                                    قدرت گرفته از
                                    <a
                                        
                                        className="mr-1 font-semibold text-[#1277fd] pointer-events-none"
