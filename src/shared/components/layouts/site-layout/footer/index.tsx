  ...
  let [activeAccordionId, setActiveAccordionId] = useState<number | null>(
    ...
    return (
        ...
        <footer className="bg-white  border-t-[1px] border-gray-200">
            <div className="container mx-auto px-4 2xl:px-20  h-auto  overflow-hidden py-24">
                <section className="mx-auto w-full max-w-screen-xl px-4 grid items-center gap-10 md:grid-cols-2 md:items-start">
                    <div className="flex flex-col items-center gap-16 md:items-start">
                        <div className="flex flex-col items-center gap-4 md:items-start">
                            ...
                            <p className="text-center font-medium text-zinc-400 leading-5">چت بات سفارشی برای کسب و کار شما</p>
                        ...
                        <div className="grid w-full grid-cols-4 gap-4 md:w-auto md:grid-cols-6">
                          ...
                          <button className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 border bg-transparent shadow-sm dark:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 disabled:bg-zinc-100/60 h-11 rounded-xl border-zinc-800 p-3 text-zinc-400 md:col-span-1 hover:bg-zinc-800/90 hover:text-white">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-6"><path fill-rule="evenodd" clip-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" fill="currentColor"></path></svg>
                          </button>
                          <button className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 border bg-transparent shadow-sm dark:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 disabled:bg-zinc-100/60 h-11 rounded-xl border-zinc-800 p-3 text-zinc-400 md:col-span-1 hover:bg-zinc-800/90 hover:text-white">
                          ...
                          <button className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 border bg-transparent shadow-sm dark:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 disabled:bg-zinc-100/60 h-11 rounded-xl border-zinc-800 p-3 text-zinc-400 md:col-span-1 hover:bg-zinc-800/90 hover:text-white">
                             <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="size-6"><g><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></g></svg>
                          </button>
                          <button className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 border bg-transparent shadow-sm dark:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 disabled:bg-zinc-100/60 h-11 rounded-xl border-zinc-800 p-3 text-zinc-400 md:col-span-1 hover:bg-zinc-800/90 hover:text-white">
                               <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="size-6"><title>YouTube Icon</title><path d="M23.498 6.186a2.966 2.966 0 00-2.084-2.084C19.654 3.333 12 3.333 12 3.333s-7.654 0-9.414.769A2.966 2.966 0 00.502 6.186C0 8.102 0 12 0 12s0 3.898.502 5.814a2.966 2.966 0 002.084 2.084c1.76.769 9.414.769 9.414.769s7.654 0 9.414-.769a2.966 2.966 0 002.084-2.084C24 15.898 24 12 24 12s0-3.898-.502-5.814zM9.545 15.568v-7.136L15.545 12l-6 3.568z"></path></svg>
                          </button>
                    ...
                    <div className="hidden md:flex lg:gap-24 md:gap-10 xl:gap-32">
                        <div className="flex flex-col gap-4">
                           <h5 className="font-semibold text-sm text-black">راهنمایی و پشتیبانی</h5>
                        ...
                        <div className="flex flex-col gap-4">
                           <h5 className="font-semibold text-sm text-black">راه کارها</h5>
                           <Link href={"/"} className="font-medium text-sm text-zinc-400 transition-colors duration-200 ease-in-out hover:text-zinc-700">
                             سوالات متداول
                           </Link>
                           <Link href={"/"} className="font-medium text-sm text-zinc-400 transition-colors duration-200 ease-in-out hover:text-zinc-700">
                        ...
                        <div className="flex flex-col gap-4">
                           <h5 className="font-semibold text-sm text-black">محصول</h5>
                           <Link href={"/"} className="font-medium text-sm text-zinc-400 transition-colors duration-200 ease-in-out hover:text-zinc-700">
                             سوالات متداول
                           </Link>
                           <Link href={"/"} className="font-medium text-sm text-zinc-400 transition-colors duration-200 ease-in-out hover:text-zinc-700">
      ...
      <div className="flex justify-center">
          <span className=" text-center text-sm text-zinc-400 md:text-start">
           <span className="font-bold ">
            ...
            <span className="mr-2">
                    تمامی حقوق مادی و معنوی این سایت متعلق به همیار چت می‌باشد.
            </span>
