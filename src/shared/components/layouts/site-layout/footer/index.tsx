...
const Footer = () => {
    ...
    HamyarChat
                            ...
                            <p className="text-center md:text-left font-medium leading-5 text-zinc-400">
    Personalized AI Assistants
    <br />
    At your service for customer satisfaction and business growth
</p>
                        ...
                        <div className="grid w-full grid-cols-3 gap-4 md:w-auto md:grid-cols-5">
                            ...
                            inline-flex h-11 items-center justify-center whitespace-nowrap
                            ...
                            <button className="w-full focus-visible:ring-ring inline-flex h-11 items-center justify-center whitespace-nowrap rounded-xl border bg-transparent p-1 text-sm font-medium text-zinc-400 shadow-sm transition-colors hover:bg-zinc-100 hover:text-white focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:bg-zinc-100/60 disabled:opacity-80 md:col-span-1 ">
                    ...
                    <section className="container mx-auto px-4 2xl:px-20 ">
                        <div className="flex justify-center">
                            <span className=" text-center text-sm text-zinc-400 md:text-start">
                                ...
                                <span className="mr-2">
    All material and intellectual property rights of this website belong to HamyarChat.
</span>
