describe('Login Flow', () => {
    ...
    it('should display validation errors when required fields are empty', () => {
      ...
      cy.contains('ایمیل الزامی است').should('be.visible');
    ...
    it('should login successfully with valid credentials', () => {
      ...
      cy.contains('ورود شما موفق آمیز بود.').should('be.visible');
    });
    ...
    it('should display an error message on failed login', () => {
      ...
      cy.contains('رمز عبور شما اشتباه می باشد').should('be.visible');
    });
